...
<div align="center">
    <h1><a href="/books" style="color: white">Book management</a></h1>
    <h3><a href="/books?action=create" style="color: white">Create new Book</a></h3>
    <table border="1" class="table table-warning table-striped table-hover">
        ...
        <c:forEach items="${bookList}" var="book">
            <tr>
                ...
                <td>${book.des}</td>
                <td>${book.quantity}</td>
                <td><a href="/cards?action=create&id=${book.id}">Borrow</a></td>
            </tr>
        </c:forEach>
    </table>
</div>
